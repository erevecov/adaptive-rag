...
export function ChatPipelineSteps({
  ...
  if (isStreaming) {
    ...
    return (
      <section
        aria-label="Chat Pipeline Steps"
        className="grid gap-3 rounded-md border border-border bg-muted/15 p-3 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/55 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/55"
        data-slot="chat-pipeline-steps"
      >
        <Button
          aria-expanded={true}
...
function StepList({ steps }: { steps: ChatStep[] }) {
  if (steps.length === 0) {
    return (
      <p
        className="rounded-md border border-dashed border-border bg-card p-2 text-xs text-muted-foreground max-[680px]:border-primary/55 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug"
...
function StepRow({ step }: { step: ChatStep }) {
  ...
  if (!hasDetail) {
    return (
      <div
        className="flex min-w-0 items-center gap-2 rounded-md border border-border bg-card p-3 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/55 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/55"
  ...
  return (
    ...
    >
      {detailEntries.map(([key, value]) => (
        <div className="grid gap-1 rounded-md bg-muted/15 p-2 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/55 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/55" key={key}>
      ...
      {usage !== undefined ? (
        <>
          <div className="grid gap-1 rounded-md bg-muted/15 p-2 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/55 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/55">
            <dt className="text-xs font-semibold uppercase tracking-normal text-muted-foreground max-[680px]:text-[0.5625rem] max-[680px]:tracking-wider">
              Model
            </dt>
