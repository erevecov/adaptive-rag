...
>(
  (
    ...
    <DropdownMenuPrimitive.Content
      className={cn(
        [
          'z-50 grid min-w-36 gap-1 rounded-md border border-border bg-popover p-1 text-sm tracking-tight text-popover-foreground shadow-[var(--shadow-popover)] motion-safe:transition-colors max-[680px]:gap-0.5 max-[680px]:p-1 max-[680px]:text-[0.625rem]',
...
>(
  (
    ...
    <DropdownMenuPrimitive.Item
      className={cn(
        [
          'flex min-h-8 max-[680px]:min-h-11 cursor-pointer items-center rounded-sm px-2 text-sm tracking-tight outline-none max-[680px]:px-2 max-[680px]:text-[0.625rem]',
