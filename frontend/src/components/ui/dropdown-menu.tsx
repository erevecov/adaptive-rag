...
>(
  (
    ...
    <DropdownMenuPrimitive.Content
      className={cn(
        [
          'z-50 grid min-w-36 gap-1 rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-[var(--shadow-popover)] max-[680px]:p-1.5',
...
>(
  (
    ...
    <DropdownMenuPrimitive.Item
      className={cn(
        [
          'flex min-h-8 max-[680px]:min-h-11 cursor-pointer items-center rounded-sm px-2 text-sm outline-none',
