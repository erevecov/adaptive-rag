...
>(
  (
    ...
    <DropdownMenuPrimitive.Content
      className={cn(
        [
'z-50 grid min-w-36 max-[680px]:min-w-28 gap-1 rounded-md border border-border bg-popover p-1 text-sm tracking-tight text-popover-foreground shadow-[var(--shadow-popover)] motion-safe:transition-colors max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/55 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter',
