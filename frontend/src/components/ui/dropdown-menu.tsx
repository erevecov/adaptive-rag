...
>(
  (
    ...
    <DropdownMenuPrimitive.Item
      className={cn(
        [
          'flex min-h-8 max-[680px]:min-h-11 cursor-pointer items-center rounded-sm px-2 text-sm tracking-tight outline-none max-[680px]:px-2.5 max-[680px]:text-[0.75rem]',
