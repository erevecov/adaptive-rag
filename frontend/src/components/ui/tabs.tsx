...
>(
  (
    ...
    const itemClassName = cn(
      [
        'inline-flex h-8 items-center justify-center rounded-sm px-3 text-sm font-medium tracking-tight max-[680px]:min-h-11 max-[680px]:px-2 max-[680px]:text-[0.6875rem]',
