  ...
  (
    ...
    const itemClassName = cn(
      [
        ...
        'text-muted-foreground motion-safe:transition-colors hover:bg-primary/15 max-[680px]:hover:bg-primary/75 hover:text-foreground active:bg-primary/20 max-[680px]:active:bg-primary/95',
