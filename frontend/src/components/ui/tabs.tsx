...
>(
  ...
  const controlClassName = cn(
    'inline-flex w-full min-w-0 items-center gap-1 rounded-md border border-border bg-muted/40 p-1 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/45 max-[680px]:p-0.5',
  ...
  (
    ...
    const itemClassName = cn(
      [
        ...
        'data-[active]:bg-card data-[active]:font-semibold data-[active]:text-foreground data-[active]:shadow-sm data-[active]:ring-1 data-[active]:ring-primary/30 max-[680px]:data-[active]:ring-primary/70',
        'data-[state=active]:bg-card data-[state=active]:font-semibold data-[state=active]:text-foreground data-[state=active]:shadow-sm data-[state=active]:ring-1 data-[state=active]:ring-primary/30 max-[680px]:data-[state=active]:ring-primary/70',
      ],
      className,
    )
