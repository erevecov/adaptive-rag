...
>(
  ...
  const controlClassName = cn(
    'inline-flex w-full min-w-0 items-center gap-1 rounded-[2px] border border-border bg-muted/40 p-1 max-[680px]:gap-0.5 max-[680px]:border-primary/95 max-[680px]:p-0.5',
...
>(
  (
    ...
    const itemClassName = cn(
      [
        'inline-flex h-8 items-center justify-center rounded-[2px] px-3 text-sm font-medium tracking-tight max-[680px]:min-h-11 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter',
