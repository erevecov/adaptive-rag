  ...
  ],
  {
    ...
    variants: {
      size: {
        ...
        md: 'h-9 px-4 py-2 max-[680px]:min-h-11 max-[680px]:px-3 max-[680px]:text-[0.75rem]',
        sm: 'h-8 px-3 text-xs max-[680px]:min-h-11 max-[680px]:px-2.5 max-[680px]:text-[0.625rem]',
      },
      variant: {
        danger:
