  ...
  ],
  {
    ...
    variants: {
      ...
      variant: {
        ...
        ghost:
          'bg-transparent text-foreground hover:bg-primary/15 hover:text-foreground active:bg-primary/20 max-[680px]:active:bg-primary/85',
        ...
        secondary:
          ...
          'border border-border bg-secondary text-secondary-foreground hover:border-primary/40 hover:bg-primary/15 hover:text-foreground active:bg-primary/20 max-[680px]:active:bg-primary/85 max-[680px]:border-primary/95',
      },
    },
  },
)
