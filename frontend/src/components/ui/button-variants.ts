...
export const buttonVariants = cva(
  [
    'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium tracking-tight max-[680px]:gap-0.5',
  ...
  ],
  {
    ...
    variants: {
      size: {
        ...
        md: 'h-9 px-4 py-2 max-[680px]:min-h-11 max-[680px]:px-2 max-[680px]:text-[0.625rem]',
