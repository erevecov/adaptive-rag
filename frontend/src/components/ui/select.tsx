  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        ...
        className={cn(
          [
            'flex h-9 w-full items-center justify-between gap-2 rounded-md border border-input bg-background px-3 py-2 text-sm tracking-tight text-foreground max-[680px]:min-h-11 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/90 max-[680px]:px-1 max-[680px]:text-base max-[680px]:leading-snug',
