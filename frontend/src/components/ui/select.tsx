          ...
          <SelectPrimitive.Viewport className="grid gap-1 p-0 max-[680px]:gap-1">
            {options.map((option) => (
              <SelectPrimitive.Item
                className={cn(
                  [
                    'relative flex min-h-8 max-[680px]:min-h-11 cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm tracking-tight outline-none max-[680px]:px-2 max-[680px]:text-[0.75rem]',
