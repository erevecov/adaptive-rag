      ...
      <SelectPrimitive.Trigger
        ...
        className={cn(
          [
            ...
            'group motion-safe:transition-colors placeholder:text-muted-foreground hover:border-primary/40 active:border-primary/50 max-[680px]:active:border-primary/70',
