  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        ...
        className={cn(
          [
            'flex h-9 w-full items-center justify-between gap-2 rounded-[2px] border border-input bg-background px-3 py-2 text-sm tracking-tight text-foreground max-[680px]:min-h-11 max-[680px]:gap-0.5 max-[680px]:border-primary/95 max-[680px]:px-0.5 max-[680px]:text-base max-[680px]:leading-snug',
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          className={cn(
            [
              'z-50 max-h-64 min-w-[var(--radix-select-trigger-width)] overflow-hidden rounded-[2px] border border-border bg-popover p-1 text-sm tracking-tight text-popover-foreground shadow-[var(--shadow-popover)] motion-safe:transition-colors max-[680px]:border-primary/95 max-[680px]:p-0.5 max-[680px]:tracking-tighter max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/95',
          ...
          <SelectPrimitive.Viewport className="grid gap-1 p-0 max-[680px]:gap-0.5">
            {options.map((option) => (
              <SelectPrimitive.Item
                className={cn(
                  [
                    'relative flex min-h-8 max-[680px]:min-h-11 cursor-default select-none items-center rounded-[2px] px-3 py-1.5 text-sm tracking-tight outline-none max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter',
