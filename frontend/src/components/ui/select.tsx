      ...
      <SelectPrimitive.Trigger
        ...
        className={cn(
          [
            ...
            'group motion-safe:transition-colors placeholder:text-muted-foreground hover:border-primary/40 max-[680px]:hover:border-primary/60 active:border-primary/50 max-[680px]:active:border-primary/75',
