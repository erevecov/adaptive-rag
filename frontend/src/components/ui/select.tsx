      ...
      <SelectPrimitive.Trigger
        ...
        className={cn(
          [
            ...
            'data-[state=open]:border-primary/95 data-[state=open]:bg-primary/45',
              ...
              <SelectPrimitive.Item
                className={cn(
                  [
                    ...
                    'text-popover-foreground motion-safe:transition-colors active:bg-primary/20 max-[680px]:active:bg-primary/75',
