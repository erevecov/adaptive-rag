...
<<<<<<< Updated upstream
            'group motion-safe:transition-colors placeholder:text-muted-foreground hover:border-primary/40 max-[680px]:hover:border-primary/85 active:border-primary/50 max-[680px]:active:border-primary/95',
            'data-[state=open]:border-primary/95 data-[state=open]:bg-primary/80',
=======
            'group motion-safe:transition-colors placeholder:text-muted-foreground hover:border-primary/40 max-[680px]:hover:border-primary/90 active:border-primary/50 max-[680px]:active:border-primary/95',
            'data-[state=open]:border-primary/95 data-[state=open]:bg-primary/75',
>>>>>>> Stashed changes
