      ...
      <SelectPrimitive.Trigger
        ...
        className={cn(
          [
            ...
            'group motion-safe:transition-colors placeholder:text-muted-foreground hover:border-primary/40 max-[680px]:hover:border-primary/70 active:border-primary/50 max-[680px]:active:border-primary/85',
            'data-[state=open]:border-primary/70 data-[state=open]:bg-primary/15',
              ...
              <SelectPrimitive.Item
                className={cn(
                  [
                    ...
                    'text-popover-foreground motion-safe:transition-colors active:bg-primary/20 max-[680px]:active:bg-primary/45',
