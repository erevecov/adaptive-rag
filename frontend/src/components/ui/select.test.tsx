...
describe('Select', () => {
  ...
  test('renders a Radix trigger and portals selectable options', async () => {
    ...
    expect(trigger.className).toContain('max-[680px]:hover:border-primary/90')
    ...
    expect(trigger.className).toContain('data-[state=open]:bg-primary/85')
    ...
    expect(option.className).toContain('max-[680px]:data-[highlighted]:bg-primary/80')
