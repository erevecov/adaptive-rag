...
describe('Select', () => {
  ...
  test('renders a Radix trigger and portals selectable options', async () => {
    ...
    expect(trigger.className).toContain('max-[680px]:hover:border-primary/65')
    expect(trigger.className).toContain('active:border-primary/50')
    expect(trigger.className).toContain('max-[680px]:active:border-primary/80')
    ...
    expect(option.className).toContain('max-[680px]:active:bg-primary/35')
