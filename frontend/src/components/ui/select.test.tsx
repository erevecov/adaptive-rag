...
describe('Select', () => {
  ...
  test('renders a Radix trigger and portals selectable options', async () => {
    ...
    expect(trigger.className).toContain('max-[680px]:hover:border-primary/55')
    expect(trigger.className).toContain('active:border-primary/50')
    expect(trigger.className).toContain('max-[680px]:active:border-primary/70')
    expect(trigger.className).toContain('data-[state=open]:border-primary/60')
    expect(trigger.className).toContain('data-[state=open]:bg-primary/10')
    ...
    expect(option.className).toContain('max-[680px]:active:bg-primary/30')
