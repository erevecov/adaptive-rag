...
describe('Select', () => {
  ...
  test('renders a Radix trigger and portals selectable options', async () => {
    ...
    expect(trigger.className).toContain('data-[state=open]:bg-primary/50')
    ...
    expect(option.className).toContain('max-[680px]:data-[highlighted]:bg-primary/45')
    expect(option.className).toContain('active:bg-primary/20')
    expect(option.className).toContain('max-[680px]:active:bg-primary/85')
