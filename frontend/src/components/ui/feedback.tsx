...
const calloutVariants = cva(
  'rounded-md border p-4 text-sm leading-relaxed tracking-tight motion-safe:transition-colors max-[680px]:border-primary/25 max-[680px]:p-1 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15',
  {
    defaultVariants: {
      tone: 'neutral',
    },
