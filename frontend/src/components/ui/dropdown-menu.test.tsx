...
describe('DropdownMenu', () => {
  ...
  test('renders shared menu content and item slots through a Radix portal', async () => {
    ...
    expect(trigger.className).toContain('max-[680px]:active:bg-primary/85')
    ...
    expect(archiveItem.className).toContain('max-[680px]:data-[highlighted]:bg-primary/45')
    expect(archiveItem.className).toContain('active:bg-primary/20')
    expect(archiveItem.className).toContain('max-[680px]:active:bg-primary/85')
