...
describe('DropdownMenu', () => {
  ...
  test('renders shared menu content and item slots through a Radix portal', async () => {
    ...
    expect(trigger.className).toContain('max-[680px]:active:bg-primary/90')
    ...
    expect(menu.className).toContain('max-[680px]:shadow-primary/95')
    ...
    expect(archiveItem.className).toContain('max-[680px]:data-[highlighted]:bg-primary/50')
    expect(archiveItem.className).toContain('active:bg-primary/20')
    expect(archiveItem.className).toContain('max-[680px]:active:bg-primary/90')
