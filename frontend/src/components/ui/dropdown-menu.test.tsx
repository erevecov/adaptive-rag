...
describe('DropdownMenu', () => {
  ...
  test('renders shared menu content and item slots through a Radix portal', async () => {
    ...
    expect(trigger.className).toContain('max-[680px]:active:bg-primary/70')
    ...
    expect(archiveItem.className).toContain('max-[680px]:data-[highlighted]:bg-primary/35')
    expect(archiveItem.className).toContain('active:bg-primary/20')
    expect(archiveItem.className).toContain('max-[680px]:active:bg-primary/70')
