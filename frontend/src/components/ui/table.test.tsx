...
describe('Table density', () => {
  test('sticky header uses card tint; rows hover for scan', () => {
    ...
    expect(screen.getByText('Latency').className).toContain('max-[680px]:tracking-wider')
    ...
    expect(screen.getByText('12ms').className).toContain('tracking-tight')
    expect(screen.getByText('12ms').className).toContain('max-[680px]:px-1.5')
