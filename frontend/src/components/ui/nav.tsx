...
export const SidebarItem = forwardRef<HTMLButtonElement, SidebarItemProps>(
  ({ active = false, className, type = 'button', ...props }, ref) => (
    <button
      className={cn(
        [
          'inline-flex h-9 w-full items-center justify-start gap-2 rounded-md px-3 text-sm font-medium tracking-tight max-[680px]:min-h-11 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:px-1.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter',
