...
export const Field = forwardRef<HTMLDivElement, FieldProps>(
  ({ className, ...props }, ref) => (
    <div
      className={cn('group/field flex flex-col gap-2 max-[680px]:gap-1', className)}
      ref={ref}
      {...props}
      data-slot="field"
    />
...
export const FieldLabel = forwardRef<HTMLLabelElement, FieldLabelProps>(
  ({ className, ...props }, ref) => (
    <label
      className={cn(
        'text-sm font-medium leading-none tracking-tight text-foreground max-[680px]:text-[0.6875rem] group-has-[:disabled]/field:cursor-not-allowed group-has-[:disabled]/field:opacity-70',
        className,
      )}
      ref={ref}
      {...props}
...
export const FieldControl = forwardRef<HTMLDivElement, FieldControlProps>(
  ({ className, ...props }, ref) => (
    <div className={cn('flex flex-col gap-2 max-[680px]:gap-1', className)} ref={ref} {...props} data-slot="field-control" />
  ),
)
  ...
  ({ className, role = 'alert', ...props }, ref) => (
    <p
      className={cn(
        ...
        'text-xs font-medium leading-relaxed tracking-tight text-destructive max-[680px]:text-[0.625rem] max-[680px]:leading-snug',
        className,
      )}
      ref={ref}
      role={role}
