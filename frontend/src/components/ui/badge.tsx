...
const badgeVariants = cva(
  [
    'inline-flex shrink-0 items-center gap-1 rounded-[2px] border px-2 py-0.5 text-xs font-medium leading-none tracking-tight tabular-nums max-[680px]:gap-0.5 max-[680px]:rounded-[2px] max-[680px]:px-0.5 max-[680px]:py-0 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter',
