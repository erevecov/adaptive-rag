...
export const DataListItem = forwardRef<HTMLLIElement, DataListItemProps>(
  ({ className, ...props }, ref) => (
    <li
      className={cn(
'min-w-0 rounded-md border border-border bg-card p-3 text-sm tracking-tight text-card-foreground max-[680px]:rounded-sm max-[680px]:border-primary/35 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/30',
