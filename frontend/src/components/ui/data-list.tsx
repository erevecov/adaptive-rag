  ...
  ({ className, ...props }, ref) => (
    <li
      className={cn(
        ...
        'motion-safe:transition-colors hover:bg-primary/15 max-[680px]:hover:bg-primary/30 active:bg-primary/20 max-[680px]:active:bg-primary/95',
        'focus-visible:outline-none focus-visible:bg-primary/15 max-[680px]:focus-visible:bg-primary/30 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring',
        className,
      )}
      ref={ref}
      {...props}
