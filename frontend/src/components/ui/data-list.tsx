  ...
  ({ className, ...props }, ref) => (
    <li
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:bg-primary/15 max-[680px]:focus-visible:bg-primary/35 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring',
        className,
      )}
      ref={ref}
      {...props}
