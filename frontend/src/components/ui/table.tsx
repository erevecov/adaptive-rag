  ...
  ({ className, ...props }, ref) => (
    <div
      className={cn(
        ...
        'max-[680px]:max-h-[min(50vh,4rem)] max-[680px]:rounded-sm max-[680px]:overscroll-y-contain',
        className,
      )}
      ref={ref}
      {...props}
  ...
  ({ className, ...props }, ref) => (
    <table
      className={cn(
        ...
        'w-full min-w-[720px] max-[680px]:min-w-[160px] border-collapse text-sm tracking-tight max-[680px]:tracking-tighter',
        className,
      )}
      ref={ref}
      {...props}
