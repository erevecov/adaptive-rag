  ...
  ({ className, ...props }, ref) => (
    <table
      className={cn(
        ...
        'w-full min-w-[720px] max-[680px]:min-w-[480px] border-collapse text-sm',
        className,
      )}
      ref={ref}
      {...props}
...
>(({ className, ...props }, ref) => (
  <thead
    className={cn(
      ...
      'sticky top-0 z-10 border-b border-border bg-card shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:border-primary/25',
      className,
    )}
    ref={ref}
    {...props}
...
export const TableCell = forwardRef<HTMLTableCellElement, TableCellProps>(
  ({ className, ...props }, ref) => (
    <td
      className={cn(
'whitespace-nowrap px-3 py-2 max-[680px]:min-h-11 max-[680px]:px-1 max-[680px]:py-1.5 max-[680px]:text-[0.5625rem] align-middle text-foreground tracking-tight',
        className,
      )}
      ref={ref}
      {...props}
