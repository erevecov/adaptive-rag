...
>(({ className, ...props }, ref) => (
  <thead
    className={cn(
      ...
      'sticky top-0 z-10 border-b border-border bg-card shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:border-primary/45 max-[680px]:shadow-primary/40',
      className,
    )}
    ref={ref}
    {...props}
...
export const TableRow = forwardRef<HTMLTableRowElement, TableRowProps>(
  ({ className, ...props }, ref) => (
    <tr
      className={cn(
        'border-b border-border motion-safe:transition-colors hover:bg-primary/15 max-[680px]:border-primary/45',
