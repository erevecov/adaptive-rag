  ...
  ({ className, ...props }, ref) => (
    <div
      className={cn(
        ...
        'max-[680px]:max-h-[min(50vh,7rem)] max-[680px]:rounded-sm max-[680px]:overscroll-y-contain',
        className,
      )}
      ref={ref}
      {...props}
  ...
  ({ className, ...props }, ref) => (
    <table
      className={cn(
        ...
        'w-full min-w-[720px] max-[680px]:min-w-[240px] border-collapse text-sm tracking-tight max-[680px]:tracking-tighter',
        className,
      )}
      ref={ref}
      {...props}
...
>(({ className, ...props }, ref) => (
  <thead
    className={cn(
      ...
      'sticky top-0 z-10 border-b border-border bg-card shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:border-primary/90 max-[680px]:shadow-primary/85',
      className,
    )}
    ref={ref}
    {...props}
...
export const TableRow = forwardRef<HTMLTableRowElement, TableRowProps>(
  ({ className, ...props }, ref) => (
    <tr
      className={cn(
        'border-b border-border motion-safe:transition-colors hover:bg-primary/15 active:bg-primary/20 max-[680px]:border-primary/90',
