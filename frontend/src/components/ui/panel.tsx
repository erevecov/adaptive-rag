...
export const PanelHeader = forwardRef<HTMLDivElement, PanelHeaderProps>(
  ({ className, ...props }, ref) => (
    <div
      className={cn('flex flex-col gap-1.5 p-4 max-[680px]:gap-1 max-[680px]:p-2.5', className)}
      ref={ref}
      {...props}
...
export const PanelTitle = forwardRef<HTMLHeadingElement, PanelTitleProps>(
  ({ className, ...props }, ref) => (
    <h3
      className={cn('text-lg font-semibold leading-none tracking-tight max-[680px]:text-sm max-[680px]:leading-tight', className)}
      ref={ref}
      {...props}
...
export const PanelBody = forwardRef<HTMLDivElement, PanelBodyProps>(
  ({ className, ...props }, ref) => (
    <div
      className={cn('p-4 pt-0 max-[680px]:p-2.5 max-[680px]:pt-0', className)}
      ref={ref}
      {...props}
