...
function createClientStub(options: Partial<ApiClient> & {
  ...
  return {
    ...
    listAdminBackgroundJobs:
      ...
      vi.fn(async () => ({ items: [], next_cursor: null })),
    listAdminJobHandlers: vi.fn(async () => []),
    enqueueAdminBackgroundJob: vi.fn(),
    getAdminBackgroundJob: vi.fn(),
    cancelAdminBackgroundJob: vi.fn(),
    retryAdminBackgroundJob: vi.fn(),
    unblockAdminBackgroundJob: vi.fn(),
    listAdminJobSchedules: vi.fn(async () => ({ items: [] })),
    createAdminJobSchedule: vi.fn(),
    updateAdminJobSchedule: vi.fn(),
    archiveAdminJobSchedule: vi.fn(),
    pauseAdminJobSchedule: vi.fn(),
    resumeAdminJobSchedule: vi.fn(),
    runAdminJobScheduleNow: vi.fn(),
