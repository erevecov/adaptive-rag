          ...
          sessions.map((session) => {
            ...
            return (
              ...
              >
                ...
                <div className="grid min-h-8 min-w-0 grid-cols-[1rem_minmax(0,1fr)_auto_1.75rem] items-center gap-1 px-1 py-0.5 max-[680px]:min-h-11 max-[680px]:grid-cols-[1rem_minmax(0,1fr)_auto_2.25rem] max-[680px]:gap-0.5">
                  <span
