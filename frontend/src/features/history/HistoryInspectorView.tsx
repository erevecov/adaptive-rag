...
function MetricCard({
  ...
  return (
    <article className="grid min-h-28 gap-2 rounded-md border border-border bg-card p-4 text-card-foreground tracking-tight max-[680px]:min-h-20 max-[680px]:gap-0.5 max-[680px]:p-1 max-[680px]:border-primary/30 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/25">
