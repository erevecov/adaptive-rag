  ...
  return (
    ...
    >
      ...
      <SegmentedControl
        ...
        className="grid w-full min-w-0 max-w-full grid-cols-[repeat(3,minmax(0,1fr))] gap-0.5 rounded-lg border-0 bg-muted/40 p-0.5 max-[680px]:rounded-md max-[680px]:border max-[680px]:border-primary/25"
      >
    ...
    <Panel
      ...
      className={
        layout === 'inline'
          ...
          : 'workspace-inspector-overlay fixed bottom-6 right-6 top-6 z-[70] grid min-h-0 max-h-none w-[min(420px,calc(100vw-48px))] gap-3 rounded-none border-y-0 border-r-0 border-l border-l-primary/25 p-3 shadow-[var(--shadow-inspector-overlay)] max-[680px]:gap-1 max-[680px]:p-1 max-[680px]:inset-0 max-[680px]:w-auto max-[680px]:border-l-0 max-[680px]:pt-[max(0.5rem,env(safe-area-inset-top))] max-[680px]:pb-[max(0.5rem,env(safe-area-inset-bottom))]'
      }
      ref={panelRef}
...
function SourceViewerPanel({ viewer }: { viewer: SourceViewerState }) {
  ...
  return (
    <Panel aria-label="Source Viewer" role="region">
      ...
      <PanelBody className="grid gap-3 p-4 pt-0 max-[680px]:gap-1.5 max-[680px]:p-1 max-[680px]:pt-0">
...
function MetricCard({
  ...
  return (
    <article className="grid min-h-28 gap-2 rounded-md border border-border bg-card p-4 text-card-foreground tracking-tight max-[680px]:min-h-24 max-[680px]:gap-0.5 max-[680px]:p-1 max-[680px]:border-primary/25 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15">
...
function MetadataItem({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border border-border bg-muted/15 p-3 max-[680px]:rounded-sm max-[680px]:border-primary/25 max-[680px]:p-1 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15">
