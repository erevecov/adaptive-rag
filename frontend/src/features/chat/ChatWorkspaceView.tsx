  ...
  return (
    ...
    >
      {shouldCollapse ? (
        ...
        <p className="rounded-md border border-border bg-muted/15 px-3 py-2 text-sm text-foreground max-[680px]:rounded-sm max-[680px]:border-primary/25 max-[680px]:px-2 max-[680px]:py-1.5 max-[680px]:text-[0.625rem] max-[680px]:leading-snug max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/20">
          {displayQuestion}
        </p>
      )}
    </div>
