    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="space-y-3 rounded-lg border border-border/60 bg-card p-4 text-left max-[680px]:space-y-1 max-[680px]:rounded-md max-[680px]:border-primary/35 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60"
          >
  ...
  return (
    <div aria-label="Chat Response" className="grid gap-4 max-[680px]:gap-0.5" role="region">
      ...
      {response.answer.trim().length > 0 || !isStreaming ? (
        <article
          className="rounded-lg border border-border bg-card p-3.5 text-card-foreground tracking-tight focus-within:border-primary max-[680px]:rounded-md max-[680px]:border-primary/60 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60"
      ...
      {appliedMemories.length > 0 ? (
        <section
          ...
          className="grid gap-2 rounded-md border border-border/80 bg-muted/20 p-3 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/60 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60"
...
function QuestionPrompt({ question }: { question: string | null }) {
  ...
  return (
    <div
      className="sticky top-0 z-10 border-b border-border bg-background pb-2 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:border-primary/60 max-[680px]:pb-0.5 max-[680px]:shadow-primary/60"
    ...
    >
      {shouldCollapse ? (
        ...
        <p className="rounded-md border border-border bg-muted/15 px-3 py-2 text-sm text-foreground max-[680px]:rounded-sm max-[680px]:border-primary/60 max-[680px]:px-1.5 max-[680px]:py-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60">
          {displayQuestion}
        </p>
      )}
    </div>
...
function ResponseDetailsPanel({
  ...
  return (
    <section
      ...
      className="rounded-md border border-border bg-muted/15 p-3 max-[680px]:rounded-sm max-[680px]:border-primary/60 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60"
    >
      <Button
        aria-expanded={expanded}
...
function UsageItem({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border border-border bg-card p-3 max-[680px]:rounded-sm max-[680px]:border-primary/60 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60">
...
function KnowledgeDraftCard({
  ...
  return (
    <article
      ...
      className="grid gap-3 rounded-md border border-border bg-card p-4 text-card-foreground max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border-primary/60 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/60"
      role="region"
    >
