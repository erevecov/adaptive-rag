...
function ResponsePanel({
  ...
  if (state === 'loading') {
    ...
    return (
      <div
        aria-live="polite"
        className="grid min-h-[8rem] place-items-center px-3 py-4 max-[680px]:min-h-[5rem] max-[680px]:px-1.5 max-[680px]:py-2"
      >
        <EmptyState
          aria-busy="true"
  ...
  if (response === null) {
    if (state === 'failed') {
      return (
        <div className="grid min-h-[8rem] place-items-center px-3 py-4 max-[680px]:min-h-[5rem] max-[680px]:px-1.5 max-[680px]:py-2">
          <EmptyState
  ...
  return (
    <div aria-label="Chat Response" className="grid gap-4 max-[680px]:gap-1" role="region">
      ...
      {response.answer.trim().length > 0 || !isStreaming ? (
        <article
          className="rounded-lg border border-border bg-card p-3.5 text-card-foreground tracking-tight focus-within:border-primary max-[680px]:rounded-md max-[680px]:border-primary/25 max-[680px]:p-1 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15"
      ...
      {appliedMemories.length > 0 ? (
        <section
          ...
          className="grid gap-2 rounded-md border border-border/80 bg-muted/20 p-3 max-[680px]:gap-1 max-[680px]:rounded-sm max-[680px]:border-primary/25 max-[680px]:p-1 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15"
  ...
  return (
    ...
    >
      {shouldCollapse ? (
        ...
        <p className="rounded-md border border-border bg-muted/15 px-3 py-2 text-sm text-foreground max-[680px]:rounded-sm max-[680px]:border-primary/25 max-[680px]:px-2 max-[680px]:py-1.5 max-[680px]:text-[0.625rem] max-[680px]:leading-snug max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15">
          {displayQuestion}
        </p>
      )}
    </div>
...
function UsageItem({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border border-border bg-card p-3 max-[680px]:rounded-sm max-[680px]:border-primary/25 max-[680px]:p-1 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15">
...
function KnowledgeDraftCard({
  ...
  return (
    <article
      ...
      className="grid gap-3 rounded-md border border-border bg-card p-4 text-card-foreground max-[680px]:gap-1.5 max-[680px]:rounded-sm max-[680px]:border-primary/25 max-[680px]:p-1 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/15"
      role="region"
    >
