...
function ResponsePanel({
  ...
  if (state === 'loading') {
    ...
    return (
      <div
        aria-live="polite"
        className="grid min-h-[8rem] place-items-center px-3 py-4 max-[680px]:min-h-[0.75rem] max-[680px]:px-0.5 max-[680px]:py-0.5"
      >
        <EmptyState
          aria-busy="true"
  ...
  if (response === null) {
    if (state === 'failed') {
      return (
        <div className="grid min-h-[8rem] place-items-center px-3 py-4 max-[680px]:min-h-[0.75rem] max-[680px]:px-0.5 max-[680px]:py-0.5">
          <EmptyState
