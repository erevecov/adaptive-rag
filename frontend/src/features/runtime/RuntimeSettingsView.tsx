  ...
  return (
    ...
    >
      ...
      <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSaveConnection}>
        ...
        <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" disabled={!canSaveConnection} type="submit">
  ...
  return (
    ...
    >
      ...
      <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSyncProviderModels}>
        ...
        <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" type="submit">Sync Models</Button>
      </form>
  ...
  return (
    ...
    >
      ...
      <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSaveGlobalSlot}>
        ...
        <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" disabled={globalSlotSyncMessage !== null} type="submit">
          Save Global Slot
        </Button>
      </form>
      ...
      <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSaveGlobalChatModel}>
        ...
        <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" disabled={chatSyncMessage !== null} type="submit">
          Save Chat Default
        </Button>
      </form>
      ...
      <section aria-label="Global Chat Retrieval" className="grid gap-3 max-[680px]:gap-0.5">
        ...
        <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSaveGlobalChatRetrieval}>
          ...
          <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" type="submit">Save Chat Retrieval</Button>
        </form>
      </section>
    </RuntimePanel>
  )
  ...
  return (
    ...
    >
      ...
      <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSaveProjectChatRetrieval}>
        ...
        <DataListItemActions className="max-[680px]:gap-0.5 max-[680px]:px-0.5">
          <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" type="submit">Save Project Retrieval Override</Button>
      ...
      <form className="grid gap-4 max-[680px]:gap-0.5" onSubmit={onSaveProjectOverride}>
        ...
        <Button className="max-[680px]:h-6 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" disabled={projectSlotSyncMessage !== null} type="submit">
