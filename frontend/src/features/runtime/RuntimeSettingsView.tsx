              ...
              return (
                ...
                >
                  ...
                  {deleteConnectionId === connection.connection_id ? (
                    <form
                      aria-label={`Delete ${connection.connection_id} Connection`}
                      className="grid gap-3 max-[680px]:gap-0.5 rounded-md border border-destructive/30 bg-destructive/10 p-3 md:col-span-2 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:border-destructive/80 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-destructive/60 max-[680px]:tracking-tighter max-[680px]:rounded-sm"
...
export function ConnectionCheckSummary({
  ...
  return (
    <Callout className="p-2 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:border-destructive/70 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-destructive/60 max-[680px]:tracking-tighter max-[680px]:rounded-sm" role="alert" tone="danger">
