...
function RuntimePanel({
  ...
  return (
    ...
    >
      ...
      <PanelBody className="max-[680px]:rounded-sm max-[680px]:overflow-x-auto max-[680px]:border-t max-[680px]:border-primary grid gap-4 p-4 pt-0 max-[680px]:gap-0.5 max-[680px]:p-0.5 max-[680px]:pt-0">{children}</PanelBody>
    </Panel>
  )
}
    ...
    >
      <section aria-label="Provider Connections" className="grid gap-3 max-[680px]:gap-0.5">
        {state === 'loading' && connections.length === 0 ? (
          ...
          <DataList className="max-[680px]:overflow-hidden max-[680px]:gap-0.5">
            {connections.map((connection) => {
              ...
              return (
                ...
                >
                  ...
                  <DataListItemActions className="max-[680px]:overflow-hidden max-[680px]:flex-wrap justify-start gap-2 md:justify-end max-[680px]:gap-0.5 max-[680px]:px-0.5">
                  ...
                  {deleteConnectionId === connection.connection_id ? (
                    ...
                    >
                      ...
                      <DataListItemActions className="max-[680px]:overflow-hidden max-[680px]:flex-wrap max-[680px]:gap-0.5 max-[680px]:px-0.5">
                        <Button className="max-[680px]:ring-offset-0 max-[680px]:overflow-hidden max-[680px]:truncate max-[680px]:h-6 max-[680px]:w-full max-[680px]:basis-full max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug"
                          disabled={state === 'loading'}
...
export function RuntimeSlotList({
  ...
  return (
    <DataList aria-label="Global Runtime Slots" className="max-[680px]:overflow-hidden max-[680px]:gap-0.5 max-[680px]:overflow-x-auto">
      {slots.map((slot) => (
        <DataListItem
          className="max-[680px]:overflow-hidden max-[680px]:rounded-sm max-[680px]:border max-[680px]:border-primary max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary flex flex-wrap items-center justify-between gap-3 max-[680px]:gap-0.5"
          key={slot.slot}
