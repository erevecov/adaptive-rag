                  ...
                  <div className="grid min-w-0 gap-2 max-[680px]:gap-0.5">
                    <div className="min-w-0 grid gap-1 max-[680px]:gap-0.5">
                      ...
                      <div className="flex flex-wrap gap-2 max-[680px]:gap-0.5">
                        <Badge className="max-[680px]:shrink max-[680px]:rounded-sm max-w-full truncate max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">
                          {providerLabel(connection.provider)} /{' '}
                          {connectionTypeLabel(connection.connection_type)}
                        </Badge>
                        <Badge className="max-[680px]:shrink max-[680px]:rounded-sm max-w-full truncate max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter" tone="neutral">
          ...
          >
            <div className="flex min-w-0 flex-1 flex-wrap items-center gap-1 max-[680px]:gap-0.5 max-[680px]:overflow-hidden">
              {value.map((capability) => (
                <Badge className="max-[680px]:shrink max-[680px]:truncate gap-1 pr-1 max-[680px]:gap-0.5 max-[680px]:pr-0.5 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter max-[680px]:border-primary max-[680px]:bg-primary max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary max-[680px]:rounded-sm" key={capability} tone="primary">
            ...
            <DataListItem className="max-[680px]:overflow-hidden grid gap-3 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border max-[680px]:border-primary max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary md:grid-cols-[minmax(0,1fr)_auto]">
              <div className="max-[680px]:overflow-hidden grid min-w-0 gap-2 max-[680px]:gap-0.5">
                <div className="min-w-0 grid gap-1 max-[680px]:gap-0.5">
                  ...
                  <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter" tone="neutral">
  ...
  return (
    <div className="flex flex-wrap gap-2 max-[680px]:gap-0.5">
      {connection.secrets.map((secret) => (
        <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter" key={secret.secret_name} tone={secret.configured ? 'success' : 'neutral'}>
        ...
        <DataList className="max-[680px]:gap-0.5">
          {providerModels.map((model) => (
            ...
            >
              ...
              <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter" tone={model.pricing ? 'primary' : 'neutral'}>
    ...
    <DataList aria-label="Global Runtime Slots" className="max-[680px]:gap-0.5 max-[680px]:overflow-x-auto">
      {slots.map((slot) => (
        ...
        >
          ...
          <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter" tone="neutral">{sourceLabel('global')}</Badge>
        </DataListItem>
      ))}
    </DataList>
  )
