    ...
    >
      <PanelHeader className="min-w-0 flex-col items-start justify-between gap-3 p-4 sm:flex-row max-[680px]:gap-1 max-[680px]:p-1.5">
        <div className="grid min-w-0 gap-1 max-[680px]:gap-0.5">
          ...
          <h2 id={id} className="text-lg font-semibold leading-none tracking-tight max-[680px]:text-[0.6875rem] max-[680px]:leading-tight">
            {title}
          </h2>
          {description ? (
      ...
      <PanelBody className="grid gap-4 p-4 pt-0 max-[680px]:gap-2 max-[680px]:p-1.5 max-[680px]:pt-0">{children}</PanelBody>
    </Panel>
  )
}
