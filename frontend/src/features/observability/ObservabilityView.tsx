...
function ObservabilityContent({
  ...
  if (summary === null) {
    ...
    if (state === 'failed') {
      return (
        <EmptyState
          className="border-destructive/40 bg-destructive/5 p-4 text-left max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:border-destructive/75 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-destructive/60 max-[680px]:tracking-tighter max-[680px]:rounded-sm"
  ...
  return (
    ...
    >
      ...
      {Array.from({ length: cardCount }, (_, index) => (
        <article
          aria-hidden="true"
          className="grid min-h-28 gap-2 rounded-md border border-border bg-card p-4 max-[680px]:min-h-10 max-[680px]:gap-0.5 max-[680px]:p-0.5 max-[680px]:border-primary/95 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/90 max-[680px]:rounded-sm"
          key={index}
        >
...
function MetricCard({
  ...
  return (
    <article
      ...
      className="grid min-h-28 gap-2 rounded-md border border-border bg-card p-4 text-card-foreground tracking-tight max-[680px]:min-h-10 max-[680px]:gap-0.5 max-[680px]:p-0.5 max-[680px]:border-primary/95 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/90 max-[680px]:rounded-sm"
    >
      <span
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-2 max-[680px]:gap-0.5">
        ...
        <Badge className="max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">{label}</Badge>
      </div>
      {children}
    </section>
  )
        ...
        <DataList className="max-[680px]:gap-0.5">
          {rows.map((row) => (
            ...
            >
              ...
              <Badge className="max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">{formatCount(row.count, 'Session')}</Badge>
            </DataListItem>
          ))}
        </DataList>
      )}
        ...
        <DataList className="max-[680px]:gap-0.5">
          {summary.errors.top_messages.map((error) => (
            ...
            >
              ...
              <Badge className="max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">{formatCount(error.count, 'Occurrence')}</Badge>
            </DataListItem>
          ))}
        </DataList>
      )}
