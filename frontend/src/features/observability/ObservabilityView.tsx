  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-2 max-[680px]:gap-0.5">
        ...
        <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">{label}</Badge>
      </div>
      {children}
    </section>
  )
        ...
        <DataList className="max-[680px]:gap-0.5 max-[680px]:overflow-x-auto">
          {rows.map((row) => (
            ...
            >
              ...
              <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">{formatCount(row.count, 'Session')}</Badge>
            </DataListItem>
          ))}
        </DataList>
      )}
        ...
        <DataList className="max-[680px]:gap-0.5 max-[680px]:overflow-x-auto">
          {summary.errors.top_messages.map((error) => (
            ...
            >
              ...
              <Badge className="max-[680px]:shrink max-[680px]:truncate max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">{formatCount(error.count, 'Occurrence')}</Badge>
            </DataListItem>
          ))}
        </DataList>
      )}
