...
export function AuthoringPanel({
  ...
  return (
    <div className="grid gap-4 tracking-tight max-[680px]:p-1.5">
...
function ProjectsPanel({
  ...
  return (
    <AuthoringSectionPanel
      ...
      title="Projects"
    >
      <form className="grid gap-4 tracking-tight max-[680px]:p-1.5" onSubmit={onCreateProject}>
...
function ProjectAccessPanel({
  ...
  return (
    <AuthoringSectionPanel
      ...
      title="Users"
    >
      <form className="grid gap-4 tracking-tight max-[680px]:p-1.5" onSubmit={onCreateUser}>
        <div className="grid gap-4 tracking-tight max-[680px]:p-1.5 md:grid-cols-2">
      ...
      <form className="grid gap-4 tracking-tight max-[680px]:p-1.5" onSubmit={onSaveMembership}>
        <div className="grid gap-4 tracking-tight max-[680px]:p-1.5 md:grid-cols-2">
...
function SourcesPanel({
  ...
  return (
    ...
    >
      <form className="grid gap-4 tracking-tight max-[680px]:p-1.5" onSubmit={onCreateSource}>
