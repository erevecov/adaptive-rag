      ...
      <PanelBody className="max-[680px]:border-t max-[680px]:border-primary grid gap-4 p-4 pt-0 max-[680px]:gap-0.5 max-[680px]:p-0.5 max-[680px]:pt-0">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3 max-[680px]:gap-0.5">
            <Button className="max-[680px]:truncate max-[680px]:h-6 max-[680px]:rounded-sm max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" type="submit" disabled={state === 'loading'}>
