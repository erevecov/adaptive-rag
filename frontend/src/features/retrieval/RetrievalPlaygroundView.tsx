                ...
                >
                  <div className="flex min-w-0 flex-wrap items-center gap-2 max-[680px]:gap-0">
                    <Badge
                      ...
                      className="max-[680px]:touch-manipulation max-[680px]:ring-offset-0 max-[680px]:overflow-hidden max-[680px]:shrink min-w-[4.5ch] justify-center tabular-nums max-[680px]:rounded-sm max-[680px]:min-w-[2.5ch] max-[680px]:px-0 max-[680px]:text-[0.5rem] max-[680px]:leading-none max-[680px]:tracking-tighter"
                      tone="neutral"
                    >
                      #{index + 1}
                    </Badge>
                    <Badge
                      ...
                      className="max-[680px]:touch-manipulation max-[680px]:ring-offset-0 max-[680px]:overflow-hidden max-[680px]:shrink max-[680px]:rounded-sm max-[680px]:leading-none min-w-[7ch] justify-center font-mono tabular-nums max-[680px]:min-w-[4.25ch] max-[680px]:px-0 max-[680px]:text-[0.5rem] max-[680px]:tracking-tighter"
                    >
