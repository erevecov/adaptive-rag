...
export function RetrievalPlaygroundPanel({
  ...
  return (
    <Panel
      ...
      role="region"
    >
      <PanelHeader className="max-[680px]:border-b max-[680px]:border-primary/95 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary p-4 max-[680px]:gap-0.5 max-[680px]:p-0.5">
      ...
      <PanelBody className="max-[680px]:border-t max-[680px]:border-primary/95 grid gap-4 p-4 pt-0 max-[680px]:gap-0.5 max-[680px]:p-0.5 max-[680px]:pt-0">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3 max-[680px]:gap-0.5">
            <Button className="max-[680px]:h-7 max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter max-[680px]:leading-snug" type="submit" disabled={state === 'loading'}>
        ...
        {error && state !== 'failed' ? (
          <InlineFeedback className="max-[680px]:rounded-sm max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter" role="alert" tone="danger">
            {error}
          </InlineFeedback>
        ) : null}
        ...
        >
          ...
          {state === 'failed' ? (
            <EmptyState
              className="border-destructive/40 bg-destructive/5 p-4 text-left tracking-tight max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:border-destructive/90 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-destructive/80 max-[680px]:tracking-tighter max-[680px]:rounded-sm"
          ...
          {results.length > 0 ? (
            <DataList aria-label="Ranked Retrieval Results" className="max-[680px]:gap-0.5">
              {results.map((result, index) => (
                <DataListItem
                  className="grid gap-2 max-[680px]:gap-0.5 max-[680px]:rounded-sm max-[680px]:border max-[680px]:border-primary/95 max-[680px]:p-0.5 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary"
                  key={result.chunk_id}
                  data-rank={index + 1}
                >
                  <div className="flex min-w-0 flex-wrap items-center gap-2 max-[680px]:gap-0.5">
                    <Badge
                      ...
                      className="min-w-[4.5ch] justify-center tabular-nums max-[680px]:min-w-[2.75ch] max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter"
                      tone="neutral"
                    >
                      #{index + 1}
                    </Badge>
                    <Badge
                      ...
                      className="max-[680px]:leading-snug min-w-[7ch] justify-center font-mono tabular-nums max-[680px]:min-w-[4.75ch] max-[680px]:px-0.5 max-[680px]:text-[0.5625rem] max-[680px]:tracking-tighter"
                    >
                    ...
                    {result.distance != null ? (
                      <span className="min-w-[8ch] text-xs tabular-nums text-muted-foreground max-[680px]:min-w-[5.5ch] max-[680px]:text-[0.5625rem] max-[680px]:leading-snug max-[680px]:tracking-tighter">
