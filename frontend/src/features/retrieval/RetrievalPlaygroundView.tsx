...
export function RetrievalPlaygroundPanel({
  ...
  return (
    <Panel
      ...
      role="region"
    >
      <PanelHeader className="p-4 max-[680px]:gap-1 max-[680px]:p-2.5">
      ...
      <PanelBody className="grid gap-4 p-4 pt-0 max-[680px]:gap-2.5 max-[680px]:p-2.5 max-[680px]:pt-0">
        <form
          className="grid gap-4 max-[680px]:gap-2.5"
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 max-[680px]:gap-2.5">
            <Field>
        ...
        >
          ...
          {state === 'failed' ? (
            <EmptyState
              className="border-destructive/40 bg-destructive/5 p-4 text-left tracking-tight max-[680px]:p-2.5"
