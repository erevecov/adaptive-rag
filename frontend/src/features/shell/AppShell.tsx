  ...
  return (
    <aside
      ...
      className={cn(
        ...
        isOpen
          ? 'w-[280px] max-[680px]:w-[min(86vw,224px)] max-[680px]:shadow-[var(--shadow-mobile-sidebar)]'
    ...
    >
      ...
      <div
        className={cn(
'grid min-h-14 grid-cols-[36px_minmax(0,1fr)] items-center gap-2.5 border-b border-border px-3 py-2.5 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/60 max-[680px]:min-h-11 max-[680px]:gap-0.5 max-[680px]:px-1 max-[680px]:py-0.5',
      ...
      >
        ...
        <nav
          ...
          className="grid min-w-0 grid-cols-2 gap-1 border-b border-border pb-2.5 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/60 max-[680px]:gap-0.5 max-[680px]:pb-1"
...
function AccountNavigationPanel({
  ...
  return (
    <nav
      ...
      className="grid content-start items-stretch self-start border-t border-border pt-[18px] shadow-[0_-1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/60 max-[680px]:pt-1"
