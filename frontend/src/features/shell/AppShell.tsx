...
export function WorkspaceTopline({
  ...
  return (
    ...
    >
      ...
      <span
        className="workspace-project-chip min-w-0 max-w-[min(34vw,12rem)] shrink overflow-hidden text-ellipsis whitespace-nowrap rounded-md border border-border bg-muted/15 px-1.5 py-0.5 text-[11px] font-bold leading-[1.2] text-muted-foreground max-[680px]:border-primary/40 max-[680px]:px-1 max-[680px]:text-[0.5625rem]"
...
'grid min-h-14 grid-cols-[36px_minmax(0,1fr)] items-center gap-2.5 border-b border-border px-3 py-2.5 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/35 max-[680px]:min-h-11 max-[680px]:gap-0.5 max-[680px]:px-1 max-[680px]:py-0.5',
      ...
      >
        ...
        <nav
          ...
          className="grid min-w-0 grid-cols-2 gap-1 border-b border-border pb-2.5 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/35 max-[680px]:gap-0.5 max-[680px]:pb-1"
...
function AccountNavigationPanel({
  ...
  return (
    <nav
      ...
      className="grid content-start items-stretch self-start border-t border-border pt-[18px] shadow-[0_-1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/35 max-[680px]:pt-1"
    ...
    <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
      <div className="relative z-[90] min-w-0" data-slot="project-selector">
        ...
        <Popover.Portal>
          <Popover.Content
            align="start"
            className="z-[120] grid w-[var(--radix-popover-trigger-width)] gap-2 rounded-lg border border-border bg-popover p-2 text-popover-foreground shadow-[var(--shadow-popover)] max-[680px]:gap-0.5 max-[680px]:rounded-md max-[680px]:border-primary/40 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/35"
