...
export function WorkspaceTopline({
  ...
  return (
    ...
    >
      ...
      <span
        className="workspace-project-chip min-w-0 max-w-[min(34vw,12rem)] shrink overflow-hidden text-ellipsis whitespace-nowrap rounded-md border border-border bg-muted/15 px-1.5 py-0.5 text-[11px] font-bold leading-[1.2] text-muted-foreground max-[680px]:border-primary/35 max-[680px]:px-1 max-[680px]:text-[0.5625rem]"
...
export function AppSidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
'grid min-h-14 grid-cols-[36px_minmax(0,1fr)] items-center gap-2.5 border-b border-border px-3 py-2.5 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/30 max-[680px]:min-h-11 max-[680px]:gap-0.5 max-[680px]:px-2 max-[680px]:py-1',
        ...
        <IconButton
          ...
          className={cn(
            ...
            !isOpen &&
              ...
              'pointer-events-auto fixed left-3.5 top-3.5 z-50 bg-card shadow-[var(--shadow-sidebar-toggle)] max-[680px]:left-2.5 max-[680px]:top-2.5 max-[680px]:border max-[680px]:border-primary/35',
          )}
      ...
      >
        ...
        <nav
          ...
          className="grid min-w-0 grid-cols-2 gap-1 border-b border-border pb-2.5 shadow-[0_1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/30 max-[680px]:gap-0.5 max-[680px]:pb-1"
...
function AccountNavigationPanel({
  ...
  return (
    <nav
      ...
      className="grid content-start items-stretch self-start border-t border-border pt-[18px] shadow-[0_-1px_0_0] shadow-primary/15 max-[680px]:shadow-primary/30 max-[680px]:pt-1"
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        subitem
          ? [
              'relative ml-3 min-h-[30px] max-[680px]:min-h-11 w-[calc(100%-0.75rem)] rounded-md px-[18px] text-xs tracking-tight max-[680px]:px-2.5 max-[680px]:text-[0.5625rem]',
    ...
    <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
      <div className="relative z-[90] min-w-0" data-slot="project-selector">
          ...
          <Button
            ...
            className={cn(
              [
                ...
                'rounded-lg border border-border bg-card px-2.5 py-2 text-left text-foreground motion-safe:transition-colors max-[680px]:rounded-md max-[680px]:border-primary/35 max-[680px]:px-1 max-[680px]:py-1 max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/30',
        ...
        <Popover.Portal>
          <Popover.Content
            align="start"
            className="z-[120] grid w-[var(--radix-popover-trigger-width)] gap-2 rounded-lg border border-border bg-popover p-2 text-popover-foreground shadow-[var(--shadow-popover)] max-[680px]:gap-0.5 max-[680px]:rounded-md max-[680px]:border-primary/35 max-[680px]:p-0.5 max-[680px]:text-[0.5625rem] max-[680px]:shadow-[0_1px_0_0] max-[680px]:shadow-primary/30"
