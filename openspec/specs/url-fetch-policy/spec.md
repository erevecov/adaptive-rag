# url-fetch-policy Specification

## Purpose

Definir la politica de descarga segura de URLs remotas para Adaptive RAG,
incluyendo validacion anti-SSRF, redirects manuales, allowlist de content
types y limite de bytes descargados.
## Requirements
