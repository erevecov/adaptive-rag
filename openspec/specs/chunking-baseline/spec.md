# chunking-baseline Specification

## Purpose

Definir el baseline determinista de chunking sobre
`document_versions.normalized_text`, preservando offsets, orden local y metadata
necesaria para embeddings y citations.
## Requirements
