"""Tests del runner hosted de chat para evals M8."""
...
def test_run_hosted_chat_eval_suite_reports_usage_and_quality(
    tmp_path: Path,
) -> None:
    ...
    report = run_hosted_chat_eval_suite(
        _make_session(),
        suite,
        provider=provider,
        runner=runner,
