...
class KnowledgeProposalRepository:
    """Persistence for workspace-scoped chat knowledge proposals.
        ...
        *,
        ...
        if origin_session_id is not None:
            self._require_session(
                workspace_id=workspace_id, session_id=origin_session_id
            )
        if origin_message_id is not None:
            self._require_message(
                workspace_id=workspace_id, message_id=origin_message_id
            )
        ...
        *,
        ...
        if status is not None:
            statement = statement.where(
                KnowledgeProposal.status == _normalize_supported_status(status)
            )
    ...
    def refine(
        ...
        *,
        ...
        proposal = self._require_pending(
    ...
    def approve(
        ...
        *,
        ...
        self._require_source(workspace_id=workspace_id, source_id=approved_source_id)
    ...
    def _require_pending(
        ...
        *,
        ...
        proposal = self.get(workspace_id=workspace_id, proposal_id=proposal_id)
        if proposal is None:
    ...
    def _require_source(self, *, workspace_id: UUID, source_id: UUID) -> Source:
    ...
    def _require_session(self, *, workspace_id: UUID, session_id: UUID) -> ChatSession:
    ...
    def _require_message(self, *, workspace_id: UUID, message_id: UUID) -> ChatMessage:
        ...
        if message is None:
            raise ValueError("chat message does not belong to workspace")
        return message
